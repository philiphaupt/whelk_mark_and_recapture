...
#  make data spatial
file.edit("./scripts/make_data_spatial.r")
...
# visualise
file.edit("./scripts/schematic_plot_of_whelk_densities.R")
...
source("./scripts/length_weight_calculations.R")# see C:/Users/Phillip Haupt/Documents/SUSTAINABLE FISHERIES/whelks/whelk_ogive/allometric_analysis/whelk_allometry/length_weight_cals.R for source
